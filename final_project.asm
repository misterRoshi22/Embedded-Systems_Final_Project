...
;final_project.c,37 :: 		Lcd_Cmd(_LCD_CLEAR);      // Clear display
	...
	CALL       _Lcd_Cmd+0
;final_project.c,40 :: 		while (1) {
L_main0:
;final_project.c,41 :: 		if (char_count > 31) { // Reset after filling both rows
	MOVF       _char_count+0, 0
	SUBLW      31
	BTFSC      STATUS+0, 0
	GOTO       L_main2
;final_project.c,42 :: 		Lcd_Cmd(_LCD_CLEAR);
	MOVLW      1
	MOVWF      FARG_Lcd_Cmd_out_char+0
	CALL       _Lcd_Cmd+0
;final_project.c,43 :: 		char_count = 0;
	CLRF       _char_count+0
;final_project.c,44 :: 		}
L_main2:
;final_project.c,46 :: 		if ((PORTD & 0x40) == 0x40) {
	MOVLW      64
	ANDWF      PORTD+0, 0
	MOVWF      R1+0
	MOVF       R1+0, 0
...
;final_project.c,56 :: 		letter = 0x00; // Reset the letter after printing
	CLRF       _letter+0
;final_project.c,57 :: 		while ((PORTD & 0x40) == 0x40); // Wait for button release (debouncing)
L_main5:
	MOVLW      64
	ANDWF      PORTD+0, 0
	MOVWF      R1+0
